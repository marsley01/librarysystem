...
export default function IssueBookPage() {
  ...
  const calculateReturnDate = useCallback(() => {
    const days = parseInt(expectedDays, 10);
    if (isNaN(days) || days < 1) return 'Invalid loan period';
    const date = new Date();
  ...
  const handleIssue = async () => {
    ...
    try {
      ...
      setError('Connection lost. The book may not have been issued. Check borrow records before retrying.');
    } finally {
      setSubmitting(false);
    }
  };
              ...
              <div className="rounded-xl border border-border bg-surface p-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="loan_days" type="number" min="1" value={expectedDays} onChange={(e) => setExpectedDays(e.target.value)} />
                  </div>
                  <div className="space-y-2">
